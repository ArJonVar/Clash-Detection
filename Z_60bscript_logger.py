...
class ghetto_logger:
    ...
    def __init__(self, title, print = True):
        ...
        if os.name == 'nt':
            self.path =r'Z:\Shared\Digital Construction Team\00_Projects\FL_60 Blossom Way\08_Working\Clash\Current Clash Report and Dynamo Assets\Y_clash_automations_logger.txt'
        else:
